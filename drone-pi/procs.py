...
def uplo(arch):
	...
	credentials = {
    'IBM_API_KEY_ID': 'SG1xMzAD4hZX_NZUltd1O1-dj4EnEHbR4KbdDEQ_Z-eo',
    'IAM_SERVICE_ID': 'iam-ServiceId-95524520-4ca1-4ccd-b9a4-fd0d6c7cbef3',
    ...
    'BUCKET': 'javier-donotdelete-pr-hvw2l109yfhdyv',
    'FILE': 'arch'
	}
...
def VisualR(ruta,dirName):
    ...
    version='2018-03-19',
    iam_apikey='Zc5EqPzHQ4e3p0iGE_oaIsCSV9SJinJ3c_rDC8q7KImF',
